...
class Navbar extends Component {
    ...
    render(){
            ...
            headers = 
                (
                    ...
                    <ul className = "nav navbar-nav">
                        ...
                        <li><Link to="/companydashboard">Dashboard</Link></li>
        ...
        if(cookie.load('cookiename') === "student")
        {
            ...
            navLogin = (
                <ul className="nav navbar-nav navbar-right">
                        <li><Link style = {{color:'black'}} to="/register"><span className="glyphicon glyphicon-tasks"></span> Register</Link></li>
                        <li><Link style = {{color:'black'}} to="/login"><span className="glyphicon glyphicon-log-in"></span> Login</Link></li>
                        <li><Link style = {{color:'black'}} to="/companylogin"><span className="glyphicon glyphicon-log-in"></span> Company Login</Link></li>
                </ul>
            )
        }
